...
extract = MicrodataExtract(
    ...
    variables=['AGE','SEX','EDUC','EMPSTAT','LABFORCE',
               'OCC','IND','INCWAGE','UHRSWORK','WTFINL'],
)
data_dir = pathlib.Path('data')

if not (os.path.isdir(data_dir) and len(os.listdir(data_dir)) > 0):
    ...
    print(f"Extract downloaded to {extract.download_dir}")